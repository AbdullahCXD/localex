...
export class Locale {
    ...
    static fromUnparsed(unparsed: UnparsedLocale): Locale {
        const { id, title, translations = {}, meta = {}, ...otherFields } = unparsed;
     ...
     */
    private interpolateParams(text: string, params: TranslationParams, escape: boolean): string {
     ...
     */
    private deepMerge(target: NestedTranslations, source: NestedTranslations): NestedTranslations {
        const result = { ...target };
